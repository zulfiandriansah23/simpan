 ...
 <div class="sticky">
    ...
    <img src="{{ asset('assets/default/web/simpanputih.png') }}" height="40px" class="header-brand-img toggle-logo" alt="logo">

    <div class="header-brand-img desktop-logo">
        <div class="d-flex align-items-center">
            <img src="{{ asset('assets/default/web/simpanputih.png') }}" height="40px" class="me-1" alt="logo">
            <h4 class="fw-bold mt-4 text-white text-uppercase text-truncate">{{$web->web_nama}}</h4>
        </div>
    </div>

    <img src="{{ asset('assets/default/web/iconsimpan.png') }}" height="40px" class="header-brand-img light-logo" alt="logo">

    <div class="header-brand-img light-logo1">
        <div class="d-flex align-items-center">
            <img src="{{ asset('assets/default/web/simpan.png') }}" height="40px" class="me-1" alt="logo">
        </div>
    </div>
@else
    <img src="{{ asset('assets/default/web/iconsimpanputih.png') }}" height="40px" class="header-brand-img toggle-logo" alt="logo">
