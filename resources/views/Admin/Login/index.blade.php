...
<div class="container-login100">
    <div class="wrap-login100 p-6">
        <div class="d-flex justify-content-center align-items-center">
            <img src="{{url('/assets/default/web/simpan.png')}}" height="75px" class="" alt="logo">
        </div>
        <div class="text-center">
            <h6 class=" mt-4 text-black text-truncate">Sistem Informasi Manajemen Persediaan<br><h4 class=" mt-3 text-black text-bold text-uppercase text-truncate">PT. Intilogam Sukses Abadi</h4></span></h4>
        </div>
        ...
        <br>
        <center><p>Created by <a href='#' title='' target='_blank'>Helen Safitri</a></p></center>
