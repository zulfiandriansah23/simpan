    ...
    public function getbarang($id)
{
    return response()->json(
        BarangModel::leftJoin(
            'tbl_jenisbarang',
            'tbl_jenisbarang.jenisbarang_id',
            '=',
            'tbl_barang.jenisbarang_id'
        )
        ->leftJoin(
            'tbl_satuan',
            'tbl_satuan.satuan_id',
            '=',
    ...
    public function show(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = BarangModel::leftJoin('tbl_jenisbarang', 'tbl_jenisbarang.jenisbarang_id', '=', 'tbl_barang.jenisbarang_id')->leftJoin('tbl_satuan', 'tbl_satuan.satuan_id', '=', 'tbl_barang.satuan_id')->orderBy('barang_id', 'DESC')->get();
...
->addColumn('totalstok', function ($row) {
    ...
    return $result;
                ...
                ->rawColumns(['action', 'img', 'jenisbarang', 'satuan', 'currency', 'totalstok'])->make(true);
        }
    }
